	                   		...
	                   		<div class="form_section">
	                   			...
	                   			<div class="form_section_content">
	                   				<select name="nationId" >
	                   					...
	                   					<option value="01" <c:out value=" ${authorInfo.nationId eq '01' ?'selected':''}"/>>국내 판매자</option>
	                   					<option value="02" <c:out value=" ${authorInfo.nationId eq '02' ?'selected':''}"/>>국외 판매자</option>
	                   				</select>
	                   			</div>
	                   		</div>
	                   		<div class="form_section">
